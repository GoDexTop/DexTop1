...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    // Create an array of promises for the chunks
    const promises = chunkedCalls.map((chunk, index) => {
      ...
      // Only push to cancellations if it's defined
      ...
      return promise
        .then(({ results: returnData, blockNumber: fetchBlockNumber }) => {
          ...
          // Accumulate and dispatch the results for the chunk
