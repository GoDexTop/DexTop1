...
export default function VersionSwitch() {
  ...
  const toggle = (
    <VersionToggle enabled={versionSwitchAvailable} to={toggleDest} onClick={handleClick}>
      <VersionLabel enabled={version === Version.v2 || !versionSwitchAvailable}>.3%</VersionLabel>
  ...
  return versionSwitchAvailable ? (
    ...
    <MouseoverTooltip text="This page is only compatible with DexTop V2.">{toggle}</MouseoverTooltip>
  )
}
