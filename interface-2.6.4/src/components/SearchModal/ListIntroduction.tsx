      ...
      <PaddedColumn>
        <AutoColumn gap="14px">
          ...
          <Text style={{ marginBottom: '8px', textAlign: 'center' }}>
            DexTop now supports token lists. You can add your own custom lists via IPFS, HTTPS and ENS.{' '}
          </Text>
          ...
          <OutlineCard style={{ marginBottom: '8px', padding: '1rem' }}>
            <Text fontWeight={400} fontSize={14} style={{ textAlign: 'center' }}>
              Token lists are an{''}
              <ExternalLink href="https://info.dextop.pro">open specification</ExternalLink>. Check out{' '}
